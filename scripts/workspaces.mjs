...
export const workspaces = [
  ...
  { name: "@oai404iao/pi-codex-runtime", directory: "pi-extensions/pi-codex-runtime", releaseStatus: "blocked", kind: "library" },
  { name: "@oai404iao/pi-codex-core", directory: "pi-extensions/pi-codex-core", releaseStatus: "blocked" },
  { name: "@oai404iao/pi-codex-web-search", directory: "pi-extensions/pi-codex-web-search", releaseStatus: "blocked" },
  { name: "@oai404iao/pi-codex-imagegen", directory: "pi-extensions/pi-codex-imagegen", releaseStatus: "blocked" },
  {
