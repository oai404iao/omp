...
configured and guarded manual releases are enabled.
`pi-codex-minimal-tools@1.3.0` was manually published from
`596d799c6f7db3508b6d46bb05cdca6ea9e3b716`; its npm `gitHead`, latest
dist-tag, and package artifact integrity match that source, and its trusted
publisher is configured for guarded releases. Only `pi-tree-continue` remains
private.
