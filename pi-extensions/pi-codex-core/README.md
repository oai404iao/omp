...
the same file are rejected before mutation, including aliases through directory
symlinks and move destinations. Repeated actions on the same path remain valid.
...
locking. Use consistent paths across tools as well; concurrent directory/symlink
