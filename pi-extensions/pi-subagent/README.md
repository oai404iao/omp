...
- **Two lifecycles**
  ...
  - background continuable runs return a stable agent id at prompt acceptance
...
The start tool resolves at prompt preflight acceptance and returns the child's stable
