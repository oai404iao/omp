...
Public and supported-package peer ranges currently require Pi 0.87.0 or
newer; the exact development target is 0.87.1, with both lock-validation
...
while it remains a private unsupported hook into Pi internals, so it
